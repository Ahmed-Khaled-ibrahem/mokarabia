      ...
      builder: (context, state) {
        ...
        return ListView(
          children: List.generate(snapshot.length,
                  (index) {
                List date = snapshot[index].value['orderdate'].
                ...
                return Slidable(
                    ...
                    motion: const ScrollMotion(),
                      children:  [
                        SlidableAction(
                          onPressed: (val){cubit.removeOrder(index, 'free');},
                        ...
                        SlidableAction(
                          onPressed: (val){cubit.removeOrder(index, 'paid');},
                  ...
                  endActionPane:  ActionPane(
                    ...
                    children: [
                      SlidableAction(
                        flex: 2,
                        onPressed: (val){cubit.removeOrder(index, 'delete');},
